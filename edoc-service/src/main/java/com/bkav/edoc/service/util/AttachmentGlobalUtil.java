...
public class AttachmentGlobalUtil {
    ...
    public String getSaveFilePath(String folderName) {
        ...
        String setupPath = PropsUtil.get(EdXMLConfigKey.ATTACHMENT_FOLDER_ROOT);
        ...
        if (!targetFolder.exists()) {
            if (!targetFolder.mkdirs()) {
                LOGGER.error("Can't create dir with" + targetFolder.getAbsolutePath());
            }
        }
    ...
    private static final Logger LOGGER = Logger.getLogger(AttachmentGlobalUtil.class);
