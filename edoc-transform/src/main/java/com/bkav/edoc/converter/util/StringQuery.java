...
public class StringQuery {
    ...
    public static final String GET_DATE = "SELECT distinct Date(create_date) FROM edoc_document where Date(create_date) > \"2021-03-04\" and Date(create_date) < \"2021-03-09\"";
