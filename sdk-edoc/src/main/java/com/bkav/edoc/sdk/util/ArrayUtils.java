...
public class ArrayUtils {
    ...
    public static <T> T[] add(T[] array, T value, int pos) {
        ...
        if (pos > array.length - 1) {
            ...
            System.arraycopy(array, pos - 1, newArray, pos, array.length - pos +
                    1);
        }
    ...
    public static <T> T[] append(T[]... arrays) {
        ...
        T[] newArray =
                (T[]) Array.newInstance(arraysClass.getComponentType(), length);
