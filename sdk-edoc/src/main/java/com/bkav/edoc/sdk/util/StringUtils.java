...
public class StringUtils {
     ...
     * @param delimiter the character whose index in the string marks where to end the
     *                  substring
     ...
     *
     * @param s         the string from which to extract the substring
     * @param delimiter the string whose last index in the string marks where to begin
     *                  the substring
     * @return the substring of <code>s</code> after but not including the last
     * occurrence of the delimiter, <code>null</code> if the string is
     * <code>null</code> or the delimiter does not occur in the string
    ...
    public static String removePunctuation(String s) {
        ...
        for (int i = 0; i < charArrayLength; i++) {
            ...
            if (ArrayUtils.contains(_PUNCTUATION, oldChar)) {
                newChar = CharPool.SPACE;
            }
    ...
    private static final char[] _PUNCTUATION = new char[]{
            '.', '/', '!', '^', '<', '>', '[', ']', '|', ':', '“', '”', '‘', '’',
            ',', '+', '\\', '|', '@', '\'', '\"', '`', '~', '#', '$', '%', '^',
            '*', '(', ')', '?', '&', '=', '_', '–', '…', '©', '€', '®', '™'
    };
